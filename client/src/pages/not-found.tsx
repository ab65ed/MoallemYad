          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-8 md:p-12 mb-12">
            ...
            <div className="space-y-4 text-right">
              <p className="text-lg text-gray-700 leading-relaxed">
                گویا در مسیری گام نهاده‌اید که به جایی نمی‌رسد؛ چون راهی که در نقشه نباشد.
              </p>
              <p className="text-gray-600 leading-relaxed">
                اما نگران نباشید، همچون مسعود محترم که هر مسیر ناشناخته را به فرصتی برای کشف تبدیل می‌کرد،
                شما نیز می‌توانید از اینجا راهی نو بگشایید.
              </p>
            </div>
          </div>
