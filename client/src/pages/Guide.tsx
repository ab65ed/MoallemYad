      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 animated-grid-bg rounded-2xl">
          ...
          <div className="flex flex-col gap-8 items-start">
            ...
            <div className="w-full">
              <div className="relative group arena-image-wrapper">
                <img src="/tabs/guide/1.jpg" alt="تصویر 1" className="w-full rounded-xl shadow-lg transition-all duration-300" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/95 backdrop-blur rounded-2xl shadow-xl border border-gray-200/50 p-8 md:p-12 mb-12">
          ...
          <div className="space-y-8">
            ...
            <div className="w-full">
              <div className="relative group arena-image-wrapper">
                <img src="/tabs/guide/2.jpg" alt="تصویر 2" className="w-full rounded-xl shadow-lg transition-all duration-300" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/95 backdrop-blur rounded-2xl shadow-xl border border-gray-200/50 p-8 md:p-12 mb-12">
          ...
          <div className="space-y-8">
            ...
            <div className="w-full">
              <div className="relative group arena-image-wrapper">
                <img src="/tabs/guide/3.jpg" alt="تصویر 3" className="w-full rounded-xl shadow-lg transition-all duration-300" />
              </div>
            </div>
          </div>
        </div>
